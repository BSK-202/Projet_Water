...
COEFF_TYPE_HABITAT = {"Apartment": 1.0, "House": 1.2, "Villa": 1.5}
COEFF_SURFACE = 0.5
...
def get_local_info(family_code):
    cursor.execute("""
        SELECT type, "surface", "nbChambre", "nbDouche", "nbVoiture", "nbCuisine", "piscine", "garage", "jardin", "nb_personne"
        FROM "Local"
        WHERE "codeFamille" = %s
    """, (family_code,))
...
def calculer_seuil(local_info):
    seuil = (
        ...
        COEFF_NB_VOITURES * local_info["nbVoiture"] +
