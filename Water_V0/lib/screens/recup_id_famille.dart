...
/*
  Cette fonction permet de stocker l'ID de famille dans les préférences partagées.
*/
...
/*
  Cette fonction permet de récupérer l'ID de fammille depuis les préférences partagées.
*/
